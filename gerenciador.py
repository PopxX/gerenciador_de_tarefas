...
def adicionar_tarefa(tarefas, nome_tarefa):
    ...
    #nome_tarefa = "tarefa padrao") -> Utilizado para definir uma tarefa padrão caso o usuário não digite nada.

    #tarefa: nome da tarefa
    #completada: indicar se essa tarefa já foi completada ou não.

    #Instanciando através de um dicionário.
...
def deletar_tarefas_completadas(tarefas):
    ...
    for tarefa in tarefas:
        if tarefa["completada"]: #igual a tarefa["completada"] == True
            tarefas.remove(tarefa)
    print("Tarefas completadas foram deletadas")
    return


#Armazenaremos todas as tarefas em uma lista
